            ...
            <div className="bg-[#F8F9F8] min-h-[100vh] w-full py-10 overflow-x-hidden overflow-y-hidden rounded-t-[50px]"> 
                    <div className="flex lg:flex-row flex-col justify-evenly items-center w-[75vw] mx-auto">
                        <div className="flex-col flex">
                            <h1 className="lg:text-6xl text-3xl lg:text-left w-[450px] text-center text-black text-left lg:w-[700px] mx-auto font-[500] mt-20">Financie, organize e gerencie</h1>
                                <ul className="flex flex-col mt-20">
                                    <li className="flex flex-row items-center">
                                        <BiCheckCircle  size={28} color="#4abd5d"/>                                        
                                        <h2 className="text-black font-light mt-3 text-lg text-center md:text-left ml-2 md:w-[500px] lg:w-[550px]">
                                    ...
                                    <div className="flex flex-row mt-20 ">
                                        <div className="flex flex-row mx-auto mb-20 ml-20 bg-gray-900 py-5 px-6 w-[270px] rounded-full cursor-pointer justify-between shadow-lg">
