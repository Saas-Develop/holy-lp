...
export default function Terms(){
    return(
        <>
            <Head>
                <title>Eu, Você & Cristo | Termos de uso</title>
            </Head>
                ...
                <div className={styles.Container}>
                    <div className={styles.LeftSide}>
                        ...
                        <div className={styles.TextContent}>
                            ...
                            Bem-vindo ao aplicativo Eu, Você & Cristo! Ao utilizar nossos serviços, você concorda com estes Termos de Uso. Leia atentamente este documento, pois ele estabelece os termos e condições que regem o uso do nosso aplicativo.
                            </p>
                            ...
                            <p className={styles.subtitle}>
                            Ao utilizar o aplicativo Eu, Você & Cristo, você concorda em:</p>
                            <p className={styles.subtitle}>
                            ...
                            4. Não enviar mensagens de spam ou perturbar outros usuários do aplicativo.
                            </p>
                            ...
                            <p className={styles.subtitle}>
                            O aplicativo Eu, Você & Cristo oferece funcionalidades como postar fotos, compartilhar stories, bate-papo e favoritar pessoas. Ao utilizar essas funcionalidades, você concorda em respeitar os direitos dos outros usuários e utilizar o aplicativo de forma responsável.
                            </p>
                            ...
                            <p className={styles.subtitle}>
                            Os cancelamentos e reembolsos estão sujeitos às políticas estabelecidas pela Next Academy. Consulte nossa Política de Reembolso para obter mais informações.
                            </p>
